    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto flex max-w-md flex-col gap-6 px-6 py-20">
        <div className="flex flex-col items-center gap-3 text-center">
          <Logo />
          <h1 className="font-display text-2xl font-semibold tracking-tight">Start free</h1>
          <p className="text-sm text-muted-foreground">No credit card required. 14-day Pro trial included.</p>
        </div>
        <ClerkFrame>
          <SignUp
            routing="path"
