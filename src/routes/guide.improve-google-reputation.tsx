    ...
    <main className="min-h-screen bg-background text-foreground">
      <article className="mx-auto max-w-3xl px-6 py-16">
        ...
        <header className="mb-10">
          <p className="mb-3 text-sm font-medium uppercase tracking-wider text-primary">Complete guide</p>
          <h1 className="text-4xl font-bold leading-tight md:text-5xl">
            How to improve your Google reputation in 2026
          </h1>
          <p className="mt-4 text-lg text-muted-foreground">
            The playbook franchises and local businesses use to go from 3.8 to 4.7 stars — without
            relying on luck or manual asks.
          </p>
        </header>

        <section className="prose prose-invert max-w-none space-y-6 text-base leading-relaxed">
          <p>
            Your Google reputation is the #1 driver of local buying decisions. Over 87% of consumers
            check reviews before visiting a business. Moving from 3.8 to 4.5 stars can
            <strong> double</strong> your profile clicks.
          </p>

          <h2 className="mt-10 text-2xl font-semibold">1. Claim and optimize Google Business Profile</h2>
          <p>
            Make sure your profile is verified with the correct primary category, accurate hours,
            fresh photos and a description featuring your city and service keywords.
          </p>

          <h2 className="mt-10 text-2xl font-semibold">2. Ask for reviews systematically</h2>
          <p>
            Build a routine: every served customer gets a short review link. Recency matters — fresh
            reviews carry more weight in Google's algorithm.
          </p>

          <h2 className="mt-10 text-2xl font-semibold">3. Reply to 100% of reviews within 24h</h2>
          <p>
            Replying signals an active profile to Google and shows customers you care.
            <Link to="/" className="text-primary underline"> Branchly's</Link> AI generates
            professional responses in seconds, on-brand.
          </p>

          <h2 className="mt-10 text-2xl font-semibold">4. Monitor your local competitors</h2>
          <p>
            Knowing the average rating of your 5 nearest competitors is what separates winners from
            laggards. Branchly benchmarks automatically by category and city.
          </p>

          <h2 className="mt-10 text-2xl font-semibold">5. Track 4 metrics weekly</h2>
          <p>
            Average rating, new review volume, response rate and sentiment. These four numbers tell
            the whole story of your reputation.
          </p>

          <div className="mt-12 rounded-xl border border-border bg-card p-8 text-center">
            <h3 className="text-2xl font-semibold">Start free with Branchly</h3>
            <p className="mt-2 text-muted-foreground">
              Monitor reviews, reply with AI and see how you stack up against competitors.
            </p>
            <Link
              to="/sign-up"
